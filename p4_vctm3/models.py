...
doc = """
Web of Lies p4_vctm3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_p4_vctm3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p4_vctm3/Instructions.html'
    instructions_beliefs = 'p4_vctm3/InstructionsBeliefs.html'
    instructions_belief_number = 'p4_vctm3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p4_vctm3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p4_vctm3/Instbeliefyesno.html'
    ...
    with open('p4_vctm3/imp_p4_vctm3_b.csv', 'r') as f:
        reader = csv.reader(f)
