...
doc = """
Web of Lies p3_vctm2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_p3_vctm2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p3_vctm2/Instructions.html'
    instructions_beliefs = 'p3_vctm2/InstructionsBeliefs.html'
    instructions_belief_number = 'p3_vctm2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p3_vctm2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p3_vctm2/Instbeliefyesno.html'
    ...
    with open('p3_vctm2/imp_p3_vctm2_a.csv', 'r') as f:
        reader = csv.reader(f)
